        ...
        <div className="relative">
          <div className="relative w-full h-96 lg:h-[500px] flex items-center justify-center">
            ...
            <div className="relative w-80 h-80">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="relative w-64 h-80">
                  ...
                  <div className="absolute top-20 left-1/2 transform -translate-x-1/2 w-32 h-20">
                    {/* Main eye */}
                    <div className="absolute top-2 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-gradient-to-br from-cyan-300 to-blue-500 rounded-full shadow-2xl shadow-cyan-400/50">
                      {/* Eye rings */}
                      <div className="absolute inset-2 border-2 border-cyan-200 rounded-full animate-spin" style={{animationDuration: '4s'}}></div>
                      <div className="absolute inset-4 border border-blue-300 rounded-full animate-spin" style={{animationDuration: '2s', animationDirection: 'reverse'}}></div>
                      <div className="absolute inset-6 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-full animate-pulse"></div>
                    </div>
                  </div>
              ...
              <div className="absolute top-24 right-12 w-1 h-1 bg-blue-300 rounded-full animate-ping opacity-60" style={{animationDelay: '0.5s'}}></div>
              <div className="absolute bottom-20 left-16 w-1 h-1 bg-cyan-400 rounded-full animate-ping opacity-80" style={{animationDelay: '1s'}}></div>
              <div className="absolute bottom-32 right-8 w-2 h-2 bg-blue-400 rounded-full animate-ping opacity-50" style={{animationDelay: '1.5s'}}></div>

              {/* Circuit lines */}
              <div className="absolute top-1/3 left-0 w-16 h-px bg-gradient-to-r from-transparent to-cyan-400 opacity-60 animate-pulse"></div>
              <div className="absolute top-1/2 right-0 w-20 h-px bg-gradient-to-l from-transparent to-blue-400 opacity-60 animate-pulse" style={{animationDelay: '1s'}}></div>
              <div className="absolute bottom-1/3 left-0 w-12 h-px bg-gradient-to-r from-transparent to-cyan-500 opacity-60 animate-pulse" style={{animationDelay: '2s'}}></div>
            </div>
          </div>
        </div>
      </div>
